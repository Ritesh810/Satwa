            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-satwa-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <FiMapPin className="w-6 h-6 text-satwa-600" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-satwa-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <FiPhone className="w-6 h-6 text-satwa-600" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-satwa-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <FiMail className="w-6 h-6 text-satwa-600" />
                  </div>
                  <div>
